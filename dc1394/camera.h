 ...
 */
LIBDC1394_API dc1394error_t dc1394_camera_set_broadcast(dc1394camera_t *camera, dc1394bool_t pwr);
LIBDC1394_API dc1394error_t dc1394_camera_get_broadcast(dc1394camera_t *camera, dc1394bool_t *pwr);
 ...
 * as a side effect.
 */
LIBDC1394_API dc1394error_t dc1394_reset_bus(dc1394camera_t *camera);
LIBDC1394_API dc1394error_t dc1394_read_cycle_timer (dc1394camera_t * camera,
        uint32_t * cycle_timer, uint64_t * local_time);

/**
 * Gets the IEEE 1394 node ID of the camera.
 */
LIBDC1394_API dc1394error_t dc1394_camera_get_node(dc1394camera_t *camera, uint32_t *node,
        uint32_t * generation);
 ...
 */
LIBDC1394_API dc1394error_t dc1394_camera_enumerate(dc1394_t *dc1394, dc1394camera_list_t **list);

/**
 * Frees the memory allocated in dc1394_enumerate_cameras for the camera list
 */
LIBDC1394_API void dc1394_camera_free_list(dc1394camera_list_t *list);

/**
 * Create a new camera based on a GUID (Global Unique IDentifier)
 */
LIBDC1394_API dc1394camera_t * dc1394_camera_new(dc1394_t *dc1394, uint64_t guid);

/**
 * Create a new camera based on a GUID and a unit number (for multi-unit cameras)
 */
LIBDC1394_API dc1394camera_t * dc1394_camera_new_unit(dc1394_t *dc1394, uint64_t guid, int unit);

/**
 * Frees a camera structure
 */
LIBDC1394_API void dc1394_camera_free(dc1394camera_t *camera);

/**
 * Print various camera information, such as GUID, vendor, model, supported IIDC specs, etc...
 */
LIBDC1394_API dc1394error_t dc1394_camera_print_info(dc1394camera_t *camera, FILE *fd);
 ...
 */
LIBDC1394_API dc1394error_t dc1394_camera_get_platform_string(dc1394camera_t *camera, const char **platform);
