 ...
 */
LIBDC1394_API dc1394error_t dc1394_video_get_supported_modes(dc1394camera_t *camera, dc1394video_modes_t *video_modes);

/**
 * Gets a list of supported video framerates for a given video mode. This function only works with non-scalable formats.
 */
LIBDC1394_API dc1394error_t dc1394_video_get_supported_framerates(dc1394camera_t *camera, dc1394video_mode_t video_mode, dc1394framerates_t *framerates);

/**
 * Gets the current framerate. This is meaningful only if the video mode is not scalable.
 */
LIBDC1394_API dc1394error_t dc1394_video_get_framerate(dc1394camera_t *camera, dc1394framerate_t *framerate);

/**
 * Sets the current framerate. This is meaningful only if the video mode is not scalable.
 */
LIBDC1394_API dc1394error_t dc1394_video_set_framerate(dc1394camera_t *camera, dc1394framerate_t framerate);

/**
 * Gets the current video mode.
 */
LIBDC1394_API dc1394error_t dc1394_video_get_mode(dc1394camera_t *camera, dc1394video_mode_t *video_mode);

/**
 * Sets the current video mode.
 */
LIBDC1394_API dc1394error_t dc1394_video_set_mode(dc1394camera_t *camera, dc1394video_mode_t video_mode);

/**
 * Gets the current operation mode.
 */
LIBDC1394_API dc1394error_t dc1394_video_get_operation_mode(dc1394camera_t *camera, dc1394operation_mode_t *mode);

/**
 * Sets the current operation mode.
 */
LIBDC1394_API dc1394error_t dc1394_video_set_operation_mode(dc1394camera_t *camera, dc1394operation_mode_t mode);

/**
 * Gets the current ISO speed.
 */
LIBDC1394_API dc1394error_t dc1394_video_get_iso_speed(dc1394camera_t *camera, dc1394speed_t *speed);

/**
 * Sets the current ISO speed. Speeds over 400Mbps require 1394B.
 */
LIBDC1394_API dc1394error_t dc1394_video_set_iso_speed(dc1394camera_t *camera, dc1394speed_t speed);

/**
 * Gets the current ISO channel
 */
LIBDC1394_API dc1394error_t dc1394_video_get_iso_channel(dc1394camera_t *camera, uint32_t * channel);

/**
 * Sets the current ISO channel
 */
LIBDC1394_API dc1394error_t dc1394_video_set_iso_channel(dc1394camera_t *camera, uint32_t channel);

/**
 * Gets the current data depth, in bits. Only meaningful for 16bpp video modes (RAW16, RGB48, MONO16,...)  
 */
LIBDC1394_API dc1394error_t dc1394_video_get_data_depth(dc1394camera_t *camera, uint32_t *depth);

/**
 * Starts/stops the isochronous data transmission. In other words, use this to control the image flow.
 */
LIBDC1394_API dc1394error_t dc1394_video_set_transmission(dc1394camera_t *camera, dc1394switch_t pwr);

/**
 * Gets the status of the video transmission
 */
LIBDC1394_API dc1394error_t dc1394_video_get_transmission(dc1394camera_t *camera, dc1394switch_t *pwr);

/**
 * Turns one-shot mode on or off
 */
LIBDC1394_API dc1394error_t dc1394_video_set_one_shot(dc1394camera_t *camera, dc1394switch_t pwr);

/**
 * Gets the status of the one-shot mode.
 */
LIBDC1394_API dc1394error_t dc1394_video_get_one_shot(dc1394camera_t *camera, dc1394bool_t *is_on);

/**
 * Turns multishot mode on or off
 */
LIBDC1394_API dc1394error_t dc1394_video_set_multi_shot(dc1394camera_t *camera, uint32_t numFrames, dc1394switch_t pwr);

/**
 * Gets the status of the multi-shot mode.
 */
LIBDC1394_API dc1394error_t dc1394_video_get_multi_shot(dc1394camera_t *camera, dc1394bool_t *is_on, uint32_t *numFrames);
 ...
 */
LIBDC1394_API dc1394error_t dc1394_video_get_bandwidth_usage(dc1394camera_t *camera, uint32_t *bandwidth);
